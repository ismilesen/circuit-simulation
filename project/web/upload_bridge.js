 ...
 *     { name, base64, error? }
 *
 * The panel validates xschem schematics and optional SPICE files on the
 * GDScript side, so this file only needs to deliver the bytes honestly.
 *
...
(function () {
  ...
  // Delivers the whole picker selection as ONE batch so the GDScript side can
  // validate the upload atomically.
  ...
  // Drag-and-drop onto the Godot canvas: also deliver as a single batch.
